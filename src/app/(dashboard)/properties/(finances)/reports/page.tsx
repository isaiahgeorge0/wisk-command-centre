import { getProperties, getAllRentPayments } from "@/app/(dashboard)/properties/actions";
import { ReportsPageClient } from "@/components/properties/reports-page-client";
import { ReportsTeaser } from "@/components/properties/reports-teaser";
...
export default async function ReportsPage() {
  ...
  const paymentsWithDetails = await getAllRentPayments();
  const tenantNameByPaymentId = Object.fromEntries(
    paymentsWithDetails.map((payment) => [payment.id, payment.tenant_name])
  );
