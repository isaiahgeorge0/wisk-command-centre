  ...
  return (
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        {unreadCount > 0 ? (
          <span className="absolute top-1.5 right-1.5 flex min-w-4 items-center justify-center rounded-full bg-wisk-section-winston px-1 py-0.5 text-[10px] font-semibold text-wisk-section-winston-fg md:top-1 md:right-1">
