...
export const STAGE_ACCENT: Record<LeadStatus, StageAccent> = {
  ...
  contacted: {
    bar: "bg-wisk-section-leads",
    border: "border-wisk-section-leads/40",
    text: "text-wisk-section-leads",
    dropBg: "bg-wisk-section-leads/[0.04]",
    ring: "ring-wisk-section-leads/25",
    sectionBg: "bg-wisk-section-leads/[0.05]",
    containerBorder: "border-l-wisk-section-leads",
  },
  qualified: {
    bar: "bg-amber-500",
