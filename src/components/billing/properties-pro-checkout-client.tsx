...
function CapabilityCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-amber-600/15 bg-card/80 p-6 shadow-sm"
    >
      <div className="mb-4 flex size-10 items-center justify-center rounded-xl border border-amber-600/20 bg-amber-600/10">
    ...
    <div>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, rgba(217,119,6,0.22) 1px, transparent 1px)",
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 py-16 text-center md:px-6 md:py-20 lg:px-8">
          <motion.p
            ...
            className="mb-6 text-xs font-semibold uppercase tracking-[0.2em] text-amber-500"
          >
            WISK Properties Pro
          </motion.p>
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(146,64,14,0.45), rgba(217,119,6,0.25))",
              boxShadow:
                "0 0 0 1px rgba(217,119,6,0.35), 0 0 40px rgba(217,119,6,0.28)",
            }}
          >
            <Building2 className="size-9 text-amber-400" aria-hidden />
          </motion.div>
          ...
          <h1 className="mb-5 text-4xl font-bold tracking-tight md:text-5xl lg:text-[3.5rem] lg:leading-[1.1]">
            ...
            <span className="mt-1 block">
              <StaggerWords
                ...
                noMotion={noMotion}
                className="bg-gradient-to-r from-amber-400 via-amber-500 to-orange-500 bg-clip-text text-transparent"
              />
            </span>
          </h1>
          ...
          >
            <span className="flex items-center gap-1.5 text-xs text-white/50">
              <Building2 className="size-3.5 text-amber-500" aria-hidden />
      ...
      >
        <motion.div
          ...
          className="rounded-2xl border border-amber-600/25 bg-card/90 p-8 shadow-[0_8px_40px_-8px_rgba(217,119,6,0.22)]"
        >
          <div className="mb-6 flex items-end justify-between">
            <div>
              <p className="mb-1 text-xs font-semibold uppercase tracking-[0.15em] text-amber-600">
                WISK Properties Pro
              </p>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(146,64,14,0.35), rgba(217,119,6,0.18))",
                boxShadow: "0 0 0 1px rgba(217,119,6,0.3)",
              }}
            >
              <Building2 className="size-5 text-amber-500" aria-hidden />
            </div>
          </div>
          ...
          <ul className="mb-8 space-y-3">
            {FEATURES.map((feature) => (
              <li key={feature} className="flex items-center gap-3">
                <span
                  className="flex size-5 shrink-0 items-center justify-center rounded-full text-[10px] text-amber-400"
                  style={{
